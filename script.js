document.addEventListener("DOMContentLoaded", () => {
    ...
    // --- 2. START MATCHMEDIA FOR SCROLL ANIMATIONS ---
    ScrollTrigger.matchMedia({
        // Desktop only (min-width: 901px to match CSS breakpoint)
        ...
        // Mobile (optional cleanup or specific logic, here just empty to allow default CSS)
        "all": function () {
            // ScrollTrigger Refresh to ensure start/end positions are correct
